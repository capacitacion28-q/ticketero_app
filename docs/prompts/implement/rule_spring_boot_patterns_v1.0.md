...
## REGLA ORIGINAL
Arquitectura en capas obligatoria (Controller → Service → Repository → Database) con patrones específicos de Spring Boot incluyendo inyección de dependencias por constructor, manejo de excepciones global, y estructura de packages.
